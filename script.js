...
let BackgroundTexts = ["SoundDesign","ShiouHsu", "ViewDemoReel", "Implementation", "UnityUnrealEngine", "FoleyFieldRecording"];
...
let xTo = gsap.quickTo(youtube, "x", {duration: 0.4, ease: "power2"}),
    yTo = gsap.quickTo(youtube, "y", {duration: 0.4, ease: "power2"});
